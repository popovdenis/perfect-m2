<?php
namespace Aheadworks\EventTickets\Block\Adminhtml\Page\Menu;

use Magento\Backend\Block\Template;
use Aheadworks\EventTickets\Block\Adminhtml\Page\Menu;
 ...
 *
 * @package Aheadworks\EventTickets\Block\Adminhtml\Page\Menu
 */
class Item extends Template
{
     ...
     * @var string
     */
    protected $_template = 'Aheadworks_EventTickets::page/menu/item.phtml';
