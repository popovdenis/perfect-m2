...
use Aheadworks\EventTickets\Model\Ticket\Action\CancelAction;
...
class CancelActionTest extends TestCase
{
    ...
    {
        $unavailableForCancelActionTicket = $this->getTicketMockUnavailableForCancelAction();
        $ticketAvailableForAction = $this->getTicketMockForCancelAction();
            ...
            ->willReturnMap(
                [
                    [
                        ...
                        $unavailableForCancelActionTicket,
                        false
                    ],
                    [
                        TicketInterface::CANCEL_ACTION_NAME,
    ...
    /**
     * Retrieve ticket mock for cancel action
     *
     * @return \PHPUnit_Framework_MockObject_MockObject
     */
    private function getTicketMockForCancelAction()
    {
    ...
    /**
     * Retrieve ticket mock unavailable for cancel action
     *
     * @return \PHPUnit_Framework_MockObject_MockObject
     */
    private function getTicketMockUnavailableForCancelAction()
    {
        $ticketMock = $this->getMockForAbstractClass(
            TicketInterface::class
        );
