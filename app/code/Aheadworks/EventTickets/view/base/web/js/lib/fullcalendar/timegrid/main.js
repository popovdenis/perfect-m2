    ...
    */
    ...
    var TimeGrid = /** @class */ (function (_super) {
        ...
        TimeGrid.prototype._renderColumns = function (cells, dateProfile) {
            ...
            var bgRow = new window.FullCalendarDayGrid.DayBgRow(this.context);
    ...
    var AbstractTimeGridView = /** @class */ (function (_super) {
        ...
        AbstractTimeGridView.prototype._renderSkeleton = function (context) {
            ...
            if (context.options.allDaySlot) { // should we display the "all-day" area?
                this.dayGrid = new window.FullCalendarDayGrid.DayGrid(// the all-day subcomponent of this view
    ...
    var TimeGridView = /** @class */ (function (_super) {
        ...
        TimeGridView.prototype._renderSkeleton = function (context) {
            ...
            if (this.dayGrid) {
                this.simpleDayGrid = new window.FullCalendarDayGrid.SimpleDayGrid(this.dayGrid);
            }
        };
    ...
    window.FullCalendarTimeGrid.AbstractTimeGridView = AbstractTimeGridView;
    window.FullCalendarTimeGrid.TimeGrid = TimeGrid;
    window.FullCalendarTimeGrid.TimeGridSlicer = TimeGridSlicer;
    window.FullCalendarTimeGrid.TimeGridView = TimeGridView;
    window.FullCalendarTimeGrid.buildDayRanges = buildDayRanges;
    window.FullCalendarTimeGrid.buildDayTable = buildDayTable;
    window.FullCalendarTimeGrid.default = main;
});
