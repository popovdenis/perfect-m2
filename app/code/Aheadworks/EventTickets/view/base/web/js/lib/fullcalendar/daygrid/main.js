...
define([
    ...
    */
    ...
    window.FullCalendarDayGrid.AbstractDayGridView = AbstractDayGridView;
    window.FullCalendarDayGrid.DayBgRow = DayBgRow;
    window.FullCalendarDayGrid.DayGrid = DayGrid;
    window.FullCalendarDayGrid.DayGridSlicer = DayGridSlicer;
    window.FullCalendarDayGrid.DayGridView = DayGridView;
    window.FullCalendarDayGrid.SimpleDayGrid = SimpleDayGrid;
    window.FullCalendarDayGrid.buildBasicDayTable = buildDayTable;
    window.FullCalendarDayGrid.default = main;
});
